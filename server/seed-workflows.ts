  ...
  const templates = [
    {
      ...
      description: "Management Review → ARC Committee Review → Final Decision",
      steps: [
        ...
        { title: "ARC Committee Review", role: "poa_board_member|poa_board_contributor", actions: ["approved", "rejected", "conditionally_approved"] },
        { title: "Final Inspection", role: "account_admin|super_admin", actions: ["approved"] },
      ],
    },
    {
      tenantId,
      name: "Management + ARC Committee",
      description: "Management Pre-Screening → ARC Committee Approval → Homeowner Notification",
      steps: [
        { title: "Application Submitted", role: "system", actions: ["proceed"] },
        { title: "Management Pre-Screening", role: "management_rep|management_manager|account_admin", actions: ["approved", "rejected"] },
        { title: "ARC Committee Review & Vote", role: "poa_board_member|poa_board_contributor", actions: ["approved", "rejected", "conditionally_approved"] },
    ...
    {
      tenantId,
      name: "Extended ARC Review",
      description: "Initial Review → ARC Committee → Board → Final Approval",
      steps: [
        { title: "Application Submitted", role: "system", actions: ["proceed"] },
        { title: "Initial Screening", role: "management_rep|management_manager|account_admin", actions: ["proceed", "rejected"] },
        { title: "ARC Committee Review", role: "poa_board_contributor", actions: ["proceed", "rejected"] },

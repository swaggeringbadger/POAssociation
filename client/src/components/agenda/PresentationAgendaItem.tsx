 ...
 *
 * Displays an agenda item with full details and inline bylaws
 * for presentation mode during meetings.
 */
...
export function PresentationAgendaItem({ item, className = '' }: PresentationAgendaItemProps) {
  ...
  return (
    <Card className={`print:break-inside-avoid ${className}`}>
